...
public class SongTrack {
	 ...
	 * iterAux < notes.size(); iterAux++) { PlayedNote auxNt = (PlayedNote)
	 * notes.get(iterAux);
	 * 
	 ...
	 * PlayedNote nt2 = (PlayedNote) inter.get(it); if (poption == 1 || poption
	 ...
	 * 0; it < inter.size(); it++) { PlayedNote nt = (PlayedNote) inter.get(it);
	 * 
	 ...
	 * " actit="+Integer.toString(actit)); PlayedNote ntact = (PlayedNote)
	 * inter.get(actit);
	 * 
