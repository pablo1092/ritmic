...
public enum Figures {	
	...
	EIGTHEEN (1,4,16, NotationType.eModern),
	SIXTEENTH (1, 8, 32, NotationType.eModern),
	THIRTY_SECOND (1, 16,64, NotationType.eModern),
	SIXTY_FOURTH (1, 32, 128,NotationType.eModern),
	HUNDRED_TWENTY_EIGHTH (1, 64, 256, NotationType.eModern),
	TWO_HUNDRED_FIFTY_SIX (1, 128, 512, NotationType.eModern),
	MAXIMA (32, 1, -2, NotationType.eMensural),
