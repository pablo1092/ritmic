...
public class Interval implements Comparable<Interval> {
	 ...
	 * 
	 * 
	 * public static Interval newAscendingIntervalBetween(PlayedNote
	 * previousNote, PlayedNote note) throws Exception { int prevOctave =
	 ...
	 * result; }
	 * 
	 * public static Interval newIntervalBetween(PlayedNote previousNote,
	 * PlayedNote note) throws Exception { final int [] MAJOR_SEMITONES =
	 * {0,2,4,5,7,9,11};//TODO Ver PlayedNote.getMIDI
	 * 
