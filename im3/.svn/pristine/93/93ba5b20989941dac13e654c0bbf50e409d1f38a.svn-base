...
public final class Key implements Comparable<Key> {
	...
	void computeFifths() throws IM3Exception {
		...
		for (KeysEnum k : KeysEnum.values()) {
			if (k.getKey().getMode().equals(this.getMode())
		...
		if (this.fifths == null) {
			throw new IM3Exception("Cannot find fifths for instrumentKey " + this.toString());
		}
	}
	 ...
	 * 
	 * @param tonality
	 * @return Always a instrumentKey or throws an exception
	 * @throws IM3Exception
	 */
